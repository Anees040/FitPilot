...
class ProfileRepository {
  ...
  Future<void> save(Profile profile) async {
    final data = {
      ...
      'onboarding_complete': profile.onboardingComplete ? 1 : 0,
  ...
  Profile _rowToProfile(Map<String, dynamic> map) {
    ...
    return Profile(
      ...
      proteinGoalG: TolerantReader.readDouble(map['protein_goal_g']),
      weekStartsMon: TolerantReader.readBool(map['week_starts_mon']) ?? true,
      hapticsOn: TolerantReader.readBool(map['haptics_on']) ?? true,
      onboardingComplete: TolerantReader.readBool(map['onboarding_complete']) ?? false,
